<template>
    ...
    <div class="text-primaryLighter leading-normal container mx-auto">
      ...
      <div class="leading-loose md:leading-relaxed  text-md">
        ...
        nel Registro Nazionale delle Associazioni di Promozione Sociale. Il
        nostro Comitato è inoltre iscritto nel Registro Regionale
        dell’Associazionismo di Promozione Sociale (determinazione dirigenziale
        n.118 del 8/7/2004), nell’Albo Nazionale degli Enti di Servizio Civile
        ...
        <div class="pt-2 leading-loose md:leading-relaxed text-md">
          ...
          nel 1967. Dopo aver attraversato, alla fine degli anni ’70, un periodo
          di difficoltà, esso è stato ricostituito nel settembre 1982. Nel corso
          degli anni ha avuto come Presidenti Aldo Spinelli, Francesco Colucci,
          Oscar Luigi Godini, Agostino Grande, Luigi Bruni, Pier Luigi Ferrenti.
          Attuale Presidente è Giovanni Granelli. I nostri obiettivi principali
          sono la diffusione dello “sport per tutti”, l’affermazione di un’etica
