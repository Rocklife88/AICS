<template>
    <div class="text-2xl text-primaryDarker pt-6 pb-2 font-medium">
        I nostri orari
      </div>
        <div class="text-lg text-primaryDarker font-medium">
      ...
      <div class="pt-2 pb-6 text-lg text-primaryDarker font-medium">
