<template>
  <footer class="bg-primaryDarker py-6">
    ...
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center md:space-x-8 px-4">
      ...
      <div class="mb-4 md:mb-0">
        <a href="/" rel="noopener noreferrer">
          <img class="md:w-20 w-10  h-auto" src="/assets/images/Logo_Mini.png" alt="AICS Logo" />
        </a>
      </div>

      <!-- Links di navigazione disposti in righe (visibili solo su md+) -->
      <div class="hidden md:flex flex-wrap justify-center md:justify-start gap-4 text-white text-sm">
        ...
        <div class="flex flex-row space-x-4">
          ...
          <ul class="flex space-x-4">
            ...
            <li><NuxtLink to="/contatti" rel="noopener noreferrer" class="hover:underline">I Nostri Contatti</NuxtLink></li>
          </ul>
        </div>
      ...
      <!-- Sezione Social media (visibile solo su md+) -->
      <div class="hidden md:flex space-x-6 mt-4 md:mt-0">
        <a rel="noopener noreferrer" href="https://www.facebook.com/aicscomitatoprovinciale.lucca/?locale=it_IT" title="Facebook" class="p-1 text-white">
          <!-- Icona Facebook -->
        ...
        <a rel="noopener noreferrer" href="https://www.instagram.com/aicslucca/?hl=da" title="Instagram" class="p-1 text-white">
          <!-- Icona Instagram -->
    ...
    <!-- Copyright -->
    <div class="text-xs text-center text-white font-bold mt-4">
