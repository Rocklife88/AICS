<template>
	<footer class="px-6 divide-y bg-primaryDarker">
		<div class="container-fluid flex flex-col justify-between py-10 mx-auto space-y-6 lg:flex-row lg:space-y-0">
			<div class="lg:w-1/3">
				<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
					<div class="flex items-center justify-center w-full rounded-full">
						<img class="w-30 h-full bg-white " src="/assets/images/Logo_Mini.png">
					</div>
				</a>
			</div>
			<div class="grid grid-cols-2 text-sm text-gray-100 gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
				<div class="space-y-3">
					<h3 class="tracki uppercase dark:text-gray-200 font-medium">Product</h3>
					<ul class="space-y-1">
						<li>
				...
				<div class="space-y-3">
					<h3 class="tracki uppercase dark:text-gray-200 font-medium">Company</h3>
					<ul class="space-y-1">
						<li>
				...
				<div class="space-y-3">
					<h3 class="uppercase dark:text-gray-200 font-medium">Developers</h3>
					<ul class="space-y-1">
						<li>
				...
				<div class="space-y-3">
					<div class="uppercase dark:text-gray-200 font-medium">Social media</div>
